  ...
  return (
    <>
      <ServiceCard
        ...
        para="  We construct and manage social media campaigns, provide content, and
            analyse data for your brand. We also establish tactics to grow
            followers and help you keep all your social profiles running
            smoothly and efficiently. Automate all these processes with us and
            save time, improve productivity, and tap into the potential of your
            audience."
      />
      <ServiceTypes data={serviceData} title="Social Media Management" />
    </>
  );
};
